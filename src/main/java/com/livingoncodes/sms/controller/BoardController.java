package com.livingoncodes.sms.controller;
...
import com.livingoncodes.sms.dto.RegistrationForm;
import com.livingoncodes.sms.entity.Board;
import com.livingoncodes.sms.repository.BoardRepository;
...
public class BoardController {
	...
	public String showBord(@PathVariable("boardName") String boardName, Model model) {
		
		LOGGER.debug("hello " + boardName);
	...
	public String editBoard(@PathVariable("boardName") String boardName, Model model) {
		...
		System.out.println("From edit  "+board.getContent());
